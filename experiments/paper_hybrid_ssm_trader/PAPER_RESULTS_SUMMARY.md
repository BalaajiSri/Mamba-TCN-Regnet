...
Compiled for **Learning Multi-Scale Market Representations for Short Horizon Cryptocurrency Trading** from the latest completed `paper_hybrid_ssm_trader` runs.

## Source And Protocol

- Aggregate source: `experiments/paper_hybrid_ssm_trader/metrics/aggregate_metrics.json`
- Run root: `runs/paper_hybrid_ssm_trader`
