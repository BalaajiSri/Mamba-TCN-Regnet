"""Create poster-ready figures from paper HybridSSM-Trader experiment artifacts.

The script uses only committed experiment summaries/logs:
- experiments/paper_hybrid_ssm_trader/metrics/aggregate_metrics.json
...
METRICS_PATH = REPO_ROOT / "experiments/paper_hybrid_ssm_trader/metrics/aggregate_metrics.json"
OUT_DIR = REPO_ROOT / "experiments/paper_hybrid_ssm_trader/figures"
