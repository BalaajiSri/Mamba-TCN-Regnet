...
- Experiment summary: `experiments/paper_alpha_seek/metrics/aggregate_metrics.json`
- Dataset/split protocol: `experiments/paper_alpha_seek/README.md`
- Architecture implementation: `models/alphaseek_hybrid.py`
