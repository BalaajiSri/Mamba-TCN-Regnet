...
Usage:
    python3 scripts/regime_analysis.py \\
        ...
        --output   experiments/paper_alpha_seek/metrics/regime_metrics.json
...
def get_args():
    ...
    p.add_argument("--output",   default=f"{ROOT}/experiments/paper_alpha_seek/metrics/regime_metrics.json")
