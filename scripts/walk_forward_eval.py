...
Usage:
    python3 scripts/walk_forward_eval.py \\
        ...
        --output   experiments/paper_hybrid_ssm_trader/metrics/walk_forward_metrics.json \\
        --window   63
"""
...
def get_args():
    ...
    p.add_argument("--output",   default=f"{ROOT}/experiments/paper_hybrid_ssm_trader/metrics/walk_forward_metrics.json")
